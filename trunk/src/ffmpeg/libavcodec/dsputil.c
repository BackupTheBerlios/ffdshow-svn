...
void block_permute_simple(INT16 *block)
{
	int i;
	INT16 temp[64];
...
void block_permute_normal(INT16 *block)
{
...
//		    4 - simple16384
//                  3 - simple16383
void dsputil_init(int use_permuted_idct,int use_simple_idct)
{
    int i, j;
...
#ifdef HAVE_MMX
    dsputil_init_mmx(use_simple_idct);
#endif
#ifdef ARCH_ARMV4L
    dsputil_init_armv4l();
#endif
