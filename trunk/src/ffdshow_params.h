...
_PARAM_OP(IDFF_fullYrange         ,presetSettings->,postproc.fullYrange     ,0,0,NULL)
_PARAM_OP(IDFF_tempNoiseFilter    ,presetSettings->,postproc.tempNoiseFilter,0,0,NULL)

_PARAM_OP(IDFF_isDeinterlace      ,presetSettings->,isDeinterlace      ,0,0,NULL)
_PARAM_OP(IDFF_fullDeinterlace    ,presetSettings->,fullDeinterlace    ,0,0,NULL)
_PARAM_OP(IDFF_deinterlaceMethod  ,presetSettings->,deinterlace.method ,0,4,NULL)
...
_PARAM_OP(IDFF_isAspect           ,presetSettings->,resizeAspect.isAspect    ,0,0,NULL)
_PARAM_OP(IDFF_aspectRatio        ,presetSettings->,resizeAspect.aspectRatio ,0,0,NULL)
_PARAM_OP(IDFF_resizeMethod       ,presetSettings->,resizeAspect.method      ,0,TpresetSettings::TresizeAspectSettings::methodNone,NULL)
_PARAM_OP(IDFF_resizeBicubicParam ,presetSettings->,resizeAspect.bicubicParam,0,400,NULL)
_PARAM_OP(IDFF_resizeXparam       ,presetSettings->,resizeAspect.xParam      ,0,100,NULL) 
_PARAM_OP(IDFF_resizeGaussParam   ,presetSettings->,resizeAspect.gaussParam  ,0,100,NULL)
_PARAM_OP(IDFF_resizeLanczosParam ,presetSettings->,resizeAspect.lanczosParam,0,10,NULL)
_PARAM_OP(IDFF_resizeGblurLum     ,presetSettings->,resizeAspect.GblurLum    ,0,200,NULL)
_PARAM_OP(IDFF_resizeGblurChrom   ,presetSettings->,resizeAspect.GblurChrom  ,0,200,NULL)
_PARAM_OP(IDFF_resizeSharpenLum   ,presetSettings->,resizeAspect.sharpenLum  ,0,200,NULL)
_PARAM_OP(IDFF_resizeSharpenChrom ,presetSettings->,resizeAspect.sharpenChrom,0,200,NULL)

_PARAM_OP(IDFF_isCropNzoom        ,presetSettings->,isCropNzoom                  ,0,0,NULL)
_PARAM_OP(IDFF_isZoom             ,presetSettings->,cropNzoom.isZoom             ,0,0,NULL)
_PARAM_OP(IDFF_magnificationX     ,presetSettings->,cropNzoom.magnificationX     ,0,100,NULL)
_PARAM_OP(IDFF_magnificationY     ,presetSettings->,cropNzoom.magnificationY     ,0,100,NULL)
_PARAM_OP(IDFF_magnificationLocked,presetSettings->,cropNzoom.magnificationLocked,0,0,NULL)
_PARAM_OP(IDFF_cropLeft           ,presetSettings->,cropNzoom.cropLeft           ,0,2048,NULL)
_PARAM_OP(IDFF_cropRight          ,presetSettings->,cropNzoom.cropRight          ,0,2048,NULL)
_PARAM_OP(IDFF_cropTop            ,presetSettings->,cropNzoom.cropTop            ,0,2048,NULL)
_PARAM_OP(IDFF_cropBottom         ,presetSettings->,cropNzoom.cropBottom         ,0,2048,NULL)
_PARAM_OP(IDFF_autocrop           ,presetSettings->,cropNzoom.autocrop           ,0,0,NULL)

_PARAM_OP(IDFF_isSubtitles        ,presetSettings->,isSubtitles                  ,0,0,NULL)
...
_PARAM_OP(IDFF_fontCharset        ,presetSettings->,font.charset                 ,0,0,NULL)
_PARAM_OP(IDFF_fontSize           ,presetSettings->,font.size                    ,2,255,NULL)
_PARAM_OP(IDFF_fontWeight         ,presetSettings->,font.weight                  ,0,900,NULL)
_PARAM_OP(IDFF_fontColor          ,presetSettings->,font.color                   ,0,0,NULL)
_PARAM_OP(IDFF_fontShadowStrength ,presetSettings->,font.shadowStrength          ,0,100,NULL)
_PARAM_OP(IDFF_fontShadowRadius   ,presetSettings->,font.shadowRadius            ,1,100,NULL)
_PARAM_OP(IDFF_fontSpacing        ,presetSettings->,font.spacing                 ,-10,10,NULL)
_PARAM_OP(IDFF_subAutoFlnm        ,presetSettings->,subtitles.autoFlnm           ,0,0,NULL)
_PARAM_OP(IDFF_subPosX            ,presetSettings->,subtitles.posX               ,0,100,NULL)
_PARAM_OP(IDFF_subPosY            ,presetSettings->,subtitles.posY               ,0,100,NULL)
_PARAM_OP(IDFF_subDelay           ,presetSettings->,subtitles.delay              ,0,0,NULL)
_PARAM_OP(IDFF_subSpeed           ,presetSettings->,subtitles.speed              ,0,0,NULL)
