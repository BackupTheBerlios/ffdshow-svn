...
_PARAM_OP(IDFF_trayIcon           ,globalSettings.,trayIcon           ,0,0,&TffDecoder::trayIconChanged)
...
_PARAM_OP(IDFF_resizeAspect       ,presetSettings->,resizeAspect       ,0,0,&TffDecoder::resizeChanged)
_PARAM_OP(IDFF_resizeFirst        ,presetSettings->,resizeFirst        ,0,0,&TffDecoder::resizeChanged)
_PARAM_OP(IDFF_resizeMethod       ,presetSettings->,resizeMethod       ,0,5,&TffDecoder::resizeChanged)
_PARAM_OP(IDFF_aspectRatio        ,presetSettings->,aspectRatio        ,0,0,&TffDecoder::resizeChanged)
_PARAM_OP(IDFF_resizeGblurLum     ,presetSettings->,resizeGblurLum     ,0,200,&TffDecoder::resizeChanged)
_PARAM_OP(IDFF_resizeGblurChrom   ,presetSettings->,resizeGblurChrom   ,0,200,&TffDecoder::resizeChanged)
_PARAM_OP(IDFF_resizeSharpenLum   ,presetSettings->,resizeSharpenLum   ,0,200,&TffDecoder::resizeChanged)
_PARAM_OP(IDFF_resizeSharpenChrom ,presetSettings->,resizeSharpenChrom ,0,200,&TffDecoder::resizeChanged)
_PARAM_OP(IDFF_isCropNzoom        ,presetSettings->,isCropNzoom        ,0,0,&TffDecoder::resizeChanged)
_PARAM_OP(IDFF_isZoom             ,presetSettings->,isZoom             ,0,0,&TffDecoder::resizeChanged)
_PARAM_OP(IDFF_magnificationX     ,presetSettings->,magnificationX     ,0,100,&TffDecoder::resizeChanged)
_PARAM_OP(IDFF_magnificationY     ,presetSettings->,magnificationY     ,0,100,&TffDecoder::resizeChanged)
_PARAM_OP(IDFF_magnificationLocked,presetSettings->,magnificationLocked,0,0,&TffDecoder::resizeChanged)
_PARAM_OP(IDFF_cropLeft           ,presetSettings->,cropLeft           ,0,2048,&TffDecoder::resizeChanged)
_PARAM_OP(IDFF_cropRight          ,presetSettings->,cropRight          ,0,2048,&TffDecoder::resizeChanged)
_PARAM_OP(IDFF_cropTop            ,presetSettings->,cropTop            ,0,2048,&TffDecoder::resizeChanged)
_PARAM_OP(IDFF_cropBottom         ,presetSettings->,cropBottom         ,0,2048,&TffDecoder::resizeChanged)
_PARAM_OP(IDFF_autocrop           ,presetSettings->,autocrop           ,0,0,&TffDecoder::resizeChanged)

_PARAM_OP(IDFF_isSubtitles        ,presetSettings->,isSubtitles        ,0,0,&TffDecoder::subsChanged)
_PARAM_OP(IDFF_orderSubtitles     ,presetSettings->,orderSubtitles     ,TpresetSettings::min_order,TpresetSettings::max_order,NULL)
_PARAM_OP(IDFF_fontCharset        ,presetSettings->,fontCharset        ,0,0,&TffDecoder::subsChanged)
_PARAM_OP(IDFF_fontSize           ,presetSettings->,fontSize           ,2,255,&TffDecoder::subsChanged)
_PARAM_OP(IDFF_fontWeight         ,presetSettings->,fontWeight         ,0,1000,&TffDecoder::subsChanged)
...
_PARAM_OP(IDFF_subDelay           ,presetSettings->,subDelay           ,0,0,&TffDecoder::subsChanged)
_PARAM_OP(IDFF_subSpeed           ,presetSettings->,subSpeed           ,0,0,&TffDecoder::subsChanged)
