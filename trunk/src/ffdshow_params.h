...
_PARAM_OP(IDFF_magnificationY     ,presetSettings->,magnificationY     ,0,100,&TffDecoder::onResizeChanged)
_PARAM_OP(IDFF_magnificationLocked,presetSettings->,magnificationLocked,0,0,&TffDecoder::onResizeChanged)
_PARAM_OP(IDFF_cropLeft           ,presetSettings->,cropLeft           ,0,2048,&TffDecoder::onResizeChanged)
_PARAM_OP(IDFF_cropRight          ,presetSettings->,cropRight          ,0,2048,&TffDecoder::onResizeChanged)
_PARAM_OP(IDFF_cropTop            ,presetSettings->,cropTop            ,0,2048,&TffDecoder::onResizeChanged)
_PARAM_OP(IDFF_cropBottom         ,presetSettings->,cropBottom         ,0,2048,&TffDecoder::onResizeChanged)
_PARAM_OP(IDFF_autocrop           ,presetSettings->,autocrop           ,0,0,&TffDecoder::onResizeChanged)
