...
static int __inline idctRowCondZ (int16_t * row)
{
...
#else  /* not ARCH_ALPHA */
static int __inline idctRowCondDC (int16_t * row)
{
	int a0, a1, a2, a3, b0, b1, b2, b3;
...
static void __inline idctCol (int16_t * col)
{
...
static void __inline idctSparseCol (int16_t * col)
{
	int a0, a1, a2, a3, b0, b1, b2, b3;
	col[0] += (1<<(COL_SHIFT-1))/W4;
	a0 = W4*col[8*0];
...
static void __inline idctSparse2Col (int16_t * col)
{
	int a0, a1, a2, a3, b0, b1, b2, b3;
	col[0] += (1<<(COL_SHIFT-1))/W4;
	a0 = W4*col[8*0];
...
void idct_ffsimple(short *block)
{
